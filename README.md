...
On touchscreens and mobile devices, tap on where you'd like to shoot an orb. To swap the orbs, tap on the shooter.

## Licensing
Access to, modification and distribution to the code and plain assets is allowed.
- Source code is covered under the MIT License, see LICENSE.md.
- Assets are under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.en). Note however that audio is third-party with sound effects having their own licensing terms.
- The compiled application uses the default GameMaker EULA, amended to allow modification and distribution of the assets provided.

## Engine
Made with GameMaker Studio 2. [Version 2022.6.1.26](https://gms.yoyogames.com/GameMaker-Installer-2022.6.1.26.exe) was used to support building for legacy 32-bit systems. This or later version of GM is required.
...
Compiling for Linux (guide) https://gamemaker.io/en/help/articles/setting-up-for-ubuntu
